...
class MisDiscusiones(Discusion):
    ...
    def agregar_discusion(self, persona, apartado, punto, discusion):
        discusion_nueva = MisDiscusiones(persona, discusion)
        self._agregar_discusion_recursivo(self.apartados, apartado, punto, discusion_nueva)

    def agregar_discusion(self, persona: MiPersona, apartado: str, punto: str, discusion: str):
        if self.discusiones is None:
            self.discusiones = MisDiscusiones(persona, apartado, punto, discusion)
        else:
            self.discusiones.agregar_discusion(persona, apartado, punto, discusion)
